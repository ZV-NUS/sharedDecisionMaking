...
public static class CreateDilScene
{
    ...
    public static void CreateScene()
    {
        ...
        controller.driverCameraHeight = 1.45f;
        controller.driverCameraForwardOffset = 1.2f;
        controller.driverCameraLookAhead = 80.0f;
        controller.driverCameraLookHeight = 1.25f;
        controller.hideEgoInDriverView = true;
        controller.driverCameraSmoothTime = 0.0f;
        controller.driverCameraRotationFollowRate = 90.0f;
        controller.lockDriverCameraToRoad = true;
